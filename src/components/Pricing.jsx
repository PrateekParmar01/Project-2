...
//   return (
//     <div className="max-w-xs mx-auto rounded-lg shadow-xl overflow-hidden h-96 w-full gap-1 hover:scale-110 hover:text-white hover:bg-[#ec9326]" style={{transition:'0.5s'}}>
...
//   return (
//     <>
//     <div className="h-1/3 pt-10 text-6xl text-sky-800 font-serif text-center">Our Pricing
//     <p className="text-xl text-black pt-4">Choose a service suitable for your event</p></div>
//     <div className="flex justify-center h-96 mt-20 mb-20 ">
//       {plans.map((plan) => (
